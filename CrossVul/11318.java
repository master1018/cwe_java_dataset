...
public class NumberFormatTest extends TestFmwk {
    ...
    public void TestCurrencyIsoPluralFormat() {
        String[][] DATA = {
                ...
                {"root@numbers=arab", "-1.23", "USD", "\u061C-\u0661\u066B\u0662\u0663\u00A0US$", "\u061C-\u0661\u066B\u0662\u0663\u00A0USD", "\u061C-\u0661\u066B\u0662\u0663 USD"}, 
    ...
    public void TestLocalizedPatternSymbolCoverage() {
        ...
        for (int i=0; i<2; i++) {
            ...
            df3.applyPattern(standardPattern); 
    ...
    public void TestNumberingSystems() {
        ...
        final TestNumberingSystemItem[] DATA = {
                ...
                new TestNumberingSystemItem( "th_TH@numbers=traditional", 1234.567, false, "\u0E51,\u0E52\u0E53\u0E54.\u0E55\u0E56\u0E57" ), 
                ...
                new TestNumberingSystemItem( "ta_IN@numbers=finance",     1234.567, false, "1,234.567" ), 
                ...
                new TestNumberingSystemItem( "en_US@numbers=mathsanb",    1234.567, false,  "𝟭,𝟮𝟯𝟰.𝟱𝟲𝟳" ), 
        };
    ...
    public void TestSetMathContext() throws ParseException {
        ...
        df.setMultiplier(1000000007); 
        String hugeNumberString = "9876543212345678987654321234567898765432123456789"; 
    ...
    public void TestCurrencyRoundingMinWithoutMax() {
        ...
        currencyFormat.setMinimumFractionDigits(0);
        expect(currencyFormat, 0.08, "CA$0.10");  
    }
    @Test
