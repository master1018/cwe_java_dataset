    ...
    static {
        {
            ...
            defaultFeaturesNonValidatingXInclude.put("http:
            defaultFeaturesNonValidatingXInclude.put("http:
        }
        {
            ...
            defaultFeaturesNonValidatingNoXInclude.put("http:
            defaultFeaturesNonValidatingNoXInclude.put("http:
        }
        {
            ...
            defaultFeaturesValidatingXInclude.put("http:
            defaultFeaturesValidatingXInclude.put("http:
        }
        {
            ...
            defaultFeaturesValidatingNoXInclude.put("http:
            defaultFeaturesValidatingNoXInclude.put("http:
        }
    }
